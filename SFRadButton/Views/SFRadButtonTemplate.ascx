...
<sitefinity:ResourceLinks runat="server" UseEmbeddedThemes="true" Theme="Basic">
    ...
    <sitefinity:ResourceFile Name="RandomSiteControls.SFRadButton.Resources.SFRadButton.min.js" AssemblyInfo="RandomSiteControls.SFRadButton.SFRadButton, RandomSiteControls" Static="True" />
...
<asp:Panel ID="buttoncontainer" runat="server" EnableViewState="false" CssClass="sfs_button">
    ...
    <asp:HiddenField ID="sfsButtonClientState" runat="server" />
</asp:Panel>
