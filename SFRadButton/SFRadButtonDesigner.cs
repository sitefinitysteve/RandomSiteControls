...
namespace RandomSiteControls.SFRadButton {
    ...
    /// </summary>
    public class SFRadButtonDesigner : SteveControlDesignerBase
    {
        /// <summary>
        ...
        public override string LayoutTemplatePath {
            get {
                var path = "~/SitefinitySteve/RandomSiteControls.SFRadButton.Views.SFRadButtonDesigner.ascx";
                return path;
            }
            set {
        ...
        public override IEnumerable<ScriptReference> GetScriptReferences() {
            ...
            res.Add(new ScriptReference("RandomSiteControls.SFRadButton.Resources.SFRadButtonDesigner.js", assemblyName));
            return res.ToArray();
        }
