...
namespace RandomSiteControls 
{
    ...
    [ParseChildren(true)]
    [Telerik.Sitefinity.Web.UI.ControlDesign.ControlDesigner(typeof(global::RandomSiteControls.ScriptStyleWidget.Designer.ScriptStyleDesigner)), PropertyEditorTitle("Scripts and Styles <i class='icon-code'></i>")]
    public class ScriptStyle : SimpleView, ICustomWidgetVisualization
    {
        ...
        public static readonly string layoutTemplatePath = "~/SitefinitySteve/RandomSiteControls.ScriptStyle.ScriptStyle.ascx";
        #endregion
    }
