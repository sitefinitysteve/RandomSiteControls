...
namespace RandomSiteControls.BackgroundImage {
    ...
    /// </summary>
    public class BackgroundImageDesigner : SteveControlDesignerBase {
        /// <summary>
        ...
        protected override string LayoutTemplateName {
            get {
                //return "RandomSiteControls.BackgroundImage.Views.BackgroundImageDesigner.ascx";
                return null;
            }
        }
        ...
        public override string LayoutTemplatePath {
            get {
                var path = "~/RandomSiteControls/RandomSiteControls.BackgroundImage.Views.BackgroundImageDesigner.ascx";
                return path;
            }
            set {
        ...
        public override IEnumerable<ScriptReference> GetScriptReferences() {
            ...
            res.Add(new ScriptReference("RandomSiteControls.BackgroundImage.Resources.BackgroundImageDesigner.js", assemblyName));
            return res.ToArray();
        }
